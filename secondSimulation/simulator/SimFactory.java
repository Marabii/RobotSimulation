...
public abstract class SimFactory {
    ...
    /**
     * initialize SimProperties object and GridManagement object with constructor
     * parameters
     * and initialize the obstacle and robot list
     * 
    ...
    public void initializeGW() {
        gwindow = new GraphicalWindow(
                (ColorCell[][]) (environment.getGrid()),
                sp.display_x,
                sp.display_y,
                sp.display_width,
                sp.display_height,
    ...
    /**
     * Function to generate the obstacles in the environment
     */
